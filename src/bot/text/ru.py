...
class Texts:
    ...
    settings_notify = T(emojize(
        'Настройки >> Уведомления\n\nЯ буду уведомлять тебя, если что-то произойдёт. Например, заранее сообщу о '
        'работах, когда интернет будет недоступен!\nОтключи уведомления, если они тебе мешают, но из-за этого мне будет'
        ' очень грустно :disappointed:\n\nВ новостных рассылках я буду рассказывать тебе об акциях, скидках и о '
